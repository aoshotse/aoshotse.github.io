...
## Overview: Decomposing Judgment in Cultural and Organizational Life
When actors evaluate cultural artifacts, behaviors, and forms of communication, the judgment presents itself as a single overall impression: a verdict on the act or object as a whole. My work shows that these judgments do not in fact respond to acts and objects as wholes. They respond to particular constituents of those acts and objects, read in context, and the constituent that drives the outcome is rarely the one the overall impression would credit.

These judgments matter because they do not remain impressions. In cultural and organizational life, they become allocation mechanisms: they decide which products are rewarded, which behaviors are condemned, which people get hired, which speakers are credited with authority, and which successes are taken as models for imitation. Because these allocations cumulate, judgments that appear aesthetic, moral, or stylistic in the moment shape durable differences in visibility, legitimacy, resources, authority, and opportunity across people, groups, and organizations.

What distinguishes my approach is not that judgments are affected by separable features; much social science already proceeds from that premise. It is that, in the domains I study, the relevant constituents are not available as conventional variables. They have to be analytically derived from objects that appear indivisible to participants and often to scholars. I develop ways to decompose these objects without stripping away their cultural content. Culture and the creative industries provide especially fertile settings for this work, because holistic judgment has long been their primary evaluative frame. To uncover what those judgments respond to, I combine computational analysis of digital traces with field, experimental, and archival data, using machine learning and AI for measurement at scale.

These decompositions let me measure more directly constructs that prior work could only proxy or assert. With object and judgment side by side, I can identify which constituents drive evaluation and how far the judgment departs from the object’s measured composition. The result is an account of how judgments misdescribe their objects—attaching to particular constituents while appearing to answer to the whole.industries, where holistic judgment has long been the primary evaluative frame and where the return to decomposing it is greatest. Its implications extend to organizations and markets, especially cultural product markets, because these settings depend on judgments of style, authority, legitimacy, reputation, and success. Across these settings, I combine computational analysis of digital trace data with field, experimental, and archival data, and use machine learning and AI for measurement and analysis at scale.
...
The paper argues that what matters is the legibility of a success, meaning whether a public and credible account exists of why it happened and what to copy. When the reasons behind a success are spelled out, would-be imitators know where to direct their attention and imitation follows. When the reasons stay vague, even a large and visible success goes uncopied. The study tests this in U.S. television, where shows are judged at once by award juries and by mass audiences. An award win arrives with a ready explanation, since the category names what was honored and critics set out why it worked, while high viewership comes with less concentrated and consistent accounts of its causes. Despite being less directly tied to revenue, award-driven breakouts draw imitation, concentrated among middle-status producers, while viewership breakouts of comparable size do not.
