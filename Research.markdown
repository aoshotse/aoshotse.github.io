...
Some acts of cultural borrowing pass without comment while others are condemned as appropriation. The paper argues that the difference reflects a shift in how high-status people now consume culture. As drawing on many cultures became a marker of status in itself, crossing cultural boundaries turned into a way of accruing value, and observers came to judge each crossing by who stands to gain from it. People object when they see a borrower extracting value at the expense of the culture being borrowed from, according to aspects of the actor's identity that they believe already covey social value. The paper calls this cultural tariffing, a social cost levied on boundary-crossing, and finds that observers' reactions turn on their beliefs about inequality.
