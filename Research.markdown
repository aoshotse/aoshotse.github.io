...
What distinguishes my approach is not that judgments are affected by separable features; much social science proceeds from that premise. It is that, in the domains I study, the relevant constituents are not available as conventional variables. They have to be analytically derived from objects that appear, to participants and often to scholars, as indivisible wholes. I develop decompositions of these objects that are both theoretically meaningful and empirically measurable, allowing me to measure directly, and typically at scale, constructs that prior work could only proxy or assert. With object and judgment side by side, I can identify which constituents drive the judgment and how far the judgment departs from the object’s measured composition. The result is an account of how judgments misdescribe their objects: attaching to particular constituents while appearing to answer to the whole.
