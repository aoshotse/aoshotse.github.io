...
What distinguishes my approach is not that judgments are affected by separable features; much social science already proceeds from that premise. It is that, in the domains I study, the relevant constituents are not available as conventional variables. They have to be analytically derived from objects that appear, to participants and often to scholars, as indivisible wholes. I develop decompositions of these objects that are both theoretically meaningful and empirically measurable. This lets me measure directly, and typically at scale, constructs that prior work could only proxy or assert. With object and judgment side by side, I can identify which constituents drive the judgment and how far the judgment departs from the object’s measured composition. The result is an account of how judgments misdescribe their objects: attaching to particular constituents while appearing to answer to the whole.

Substantively, my work is anchored in culture and the creative industries, where holistic judgment has long been the primary evaluative frame and where the return to decomposing it is greatest. Its implications extend to organizations and markets, especially cultural product markets, because these settings depend on judgments of style, authority, legitimacy, reputation, and success. Across these settings, I combine computational analysis of digital trace data with field, experimental, and archival data, and use machine learning and AI for measurement and analysis at scale.
